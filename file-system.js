...
export function baseName(fileName, ...args) {
...
export async function readdir(dirPath, options = { encoding: "utf8" }) {
    let reason = null,
...
export function readdirSync(dirPath, options = { encoding: "utf8" }) {
    try {
...
export function mkdirSync(dirPath, options = { recursive: true }) {
    try {
...
export async function deleteDir(dirPath, options = { recursive: false }) {
    let reason = null;
...
export function deleteDirSync(dirPath, options = { recursive: false }) {
    try {
...
export async function readFile(filePath, options = { encoding: "utf8" }) {
    let reason = null,
...
export function readFileSync(filePath, options = { encoding: "utf8" }) {
    try {
...
export async function writeFile(filePath, data, options = { encoding: "utf8" }) {
    let reason = null;
...
export function writeFileSync(filePath, data, options = { encoding: "utf8" }) {
    try {
...
export async function isFileEmpty(dirPath, options = { encoding: "utf8" }) {
    let { data } = await readFile(dirPath, options);
    return data && data.length === 0 ? true : data && data.length ? false : true;
}

export function isFileEmptySync(dirPath, options = { encoding: "utf8" }) {
    let { data } = readFileSync(dirPath, options);
    return data && data.length === 0 ? true : data && data.length ? false : true;
}

export async function isDirectoryEmpty(dirPath, options = { encoding: "utf8" }) {
    let { data } = await readdir(dirPath, options);
    return data && data.length === 0 ? true : data && data.length ? false : true;
}

export function isDirectoryEmptySync(dirPath, options = { encoding: "utf8" }) {
    let { data } = readdirSync(dirPath, options);
    return data && data.length === 0 ? true : data && data.length ? false : true;
}

export async function getAllFilesFromDirectory(dirPath, fileExt = null) {
...
export function getAllFilesFromDirectorySync(dirPath, fileExt = null) {
    if (isDirectory(dirPath)) {
...
export async function getAllDirsFromDirectory(dirPath) {
    if (isDirectory(dirPath)) {
        let { data } = await readdir(dirPath);
        return data.filter(item => {
...
export function getAllDirsFromDirectorySync(dirPath) {
    if (isDirectory(dirPath)) {
        let { data } = readdirSync(dirPath);
        return data.filter(item => {
            let directoryPath = path.join(dirPath, item);
...
export function getFileObject(filePath) {
...
export async function getAllFilesRecursively(dirPath, excludedFolders = []) {
    let allFiles = [],
...
export function getAllFilesRecursivelySync(dirPath, excludedFolders = []) {
    let allFiles = [],
...
export async function deleteAllFilesInDirPath(dirPath, recursive = false) {
...
export async function deleteAllDirsInDirPath(dirPath, options = { recursive: false }) {
    let readDirResultObject = await readdir(dirPath),
        { data, result } = readDirResultObject,
        results = [],
        errorMessages = [];
...
export async function deleteAllInDirPath(dirPath) {
...
export async function deleteAllEmptyFilesInDirectory(dirPath, recursive) {
...
export async function deleteAllEmptyDirsInDirectory(dirPath, recursive) {
    let resultObject = await readdir(dirPath),
...
export function getFileExtensionsByMimeType(mimeType) {
    return Object.keys(mimeTypes).filter(key => mimeTypes[key] === mimeType).map(item => `${item}`);
}

export function getSpecifiedExt(url, fileExtensions) {
...
export async function createDirPath(...args) {
...
export async function createSvgFile(filePath, svgName, svgData) {

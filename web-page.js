export default function getWebPageUtils({ moderator, slowDown, waitForCondition, getAllObjectKeys, toUrl })   {

    async function scrollToBottom(targetDistanceFromBottom = 200, targetEl = document.documentElement, maxTimeout = 10) {
    ...
    async function scrollToTop(targetDistanceFromTop = 0, targetEl = document.documentElement, maxTimeout = 10) {
    ...
    function getMouseCoordsOnElement(event, element) {
